...
public class JwtTokenUtils {
    ...
    public static void extensionExpirationTime(String token) {
        final Date createdDate = new Date();
        final Date nowExpirationDate = new Date(createdDate.getTime() + SecurityConstants.EXPIRATION * 1000);
        getTokenBody(token).setExpiration(nowExpirationDate);
    }
